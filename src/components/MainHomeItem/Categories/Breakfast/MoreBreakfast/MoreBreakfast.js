...
const MoreBreakfast = () => {
    ...
    //         .then(res => res.json())
    //         .then(data => setBreakfastAll(data))
    // }, [])
    ...
    useEffect(() => {
        fetch(`https://boiling-badlands-11783.herokuapp.com/showItemBySearch`, {
            ...
            body: JSON.stringify({ name: searchInput, template: 'breakfast' })
        })
            .then(res => res.json())
    ...
    return (
        <div className='bg-'>
            ...
            <div className='row container mx-auto moreBreakfast-main'>
                                    ...
                                    <div className='bg-image ripple ripple-surface ripple-surface-light'>
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <div class="d-flex justify-content-between mb-0">
                                                ...
                                                <p class="text-dark mb-0 small font-weight-normal">$ {pd.price}</p>
                                            </div>

                                            <div class="d-flex justify-content-between mb-3 name-size">
                                                <h6 class="text-dark mb-0 text-start" style={{fontSize:'1.5vh'}}>{pd.name}</h6>
