...
const MoreLunch = () => {
    ...
    useEffect(() =>{
        fetch(`https://boiling-badlands-11783.herokuapp.com/showItemBySearch`,{
            ...
            body:JSON.stringify({name: searchInput,template: 'launch'})
        })
        .then(res => res.json())
    ...
    return (
        <div className=''>
                ...
                <div className='row container mx-auto moreLunch-main'>
...
// const MoreLunch = () => {
//     const [lunchAll, setLunchAll] = useState([])
